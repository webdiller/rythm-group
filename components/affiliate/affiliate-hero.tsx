...
export function AffiliateHero({ data, enableAffiliateCooperationFormats, backgroundLightSrc = "/backgrounds/hero-affiliate-light.webp", backgroundDarkSrc = "/backgrounds/hero-affiliate-dark.webp" }: AffiliateHeroProps) {
  ...
  const ctaPrimary = data ? (locale === "en" ? data.cta_primary_en : data.cta_primary_ru) : a.ctaPrimary
  const ctaSecondary = data ? (locale === "en" ? data.cta_secondary_en : data.cta_secondary_ru) : a.ctaSecondary
  ...
  return (
    <div className="relative">
      ...
      >
        ...
        <div className={`relative z-10 mx-auto max-w-7xl text-center transition-opacity duration-300 ${heroContentVisible ? "opacity-100" : "opacity-0"}`}>
          <StaggerItem
            index={0}
            delayStart={100}
            delayStep={50}
          ...
          <StaggerItem
            ...
            durationClassName="duration-700"
          >
            <h1 className="mb-6 text-balance text-3xl font-bold leading-tight tracking-tight text-foreground md:text-5xl lg:text-7xl">{title}</h1>
          </StaggerItem>
          ...
          <StaggerItem
            ...
            durationClassName="duration-700"
          >
            <p className="mx-auto mb-10 max-w-2xl text-pretty text-lg leading-relaxed md:text-xl">{subtitle}</p>
          </StaggerItem>
