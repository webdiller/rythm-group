...
type BlogPageBreadcrumbsProps =
  | { variant: "index" }
  | { variant: "category"; category: BlogCategory }
  | { variant: "post"; category: BlogCategory; postTitle: string }
  ...
  return (
    <AppBreadcrumbs
      items={[
        { label: homeLabel, href: "/" },
        { label: blogLabel, href: "/blog" },
        { label: catLabel, href: `/blog/${props.category.slug}` },
        { label: props.postTitle },
      ]}
    />
  )
}
