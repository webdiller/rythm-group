...
function SortableFaqCard({ item, onChange, onDelete, onSave, isSaving, isDeleting }: { item: AffiliateFaq; onChange: (id: number, patch: Partial<AffiliateFaq>) => void; onDelete: (id: number) => Promise<void>; onSave: (item: AffiliateFaq) => Promise<void>; isSaving: boolean; isDeleting: boolean }) {
