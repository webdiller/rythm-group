...
export function LandingBlogSection({ posts, categories, showDates, animationsEnabled = true }: LandingBlogSectionProps) {
  const { t } = useLocale()
        ...
        <ScrollReveal disabled={!animationsEnabled}>
          <div className="mb-10 flex flex-col gap-4 md:mb-12 md:flex-row md:items-end md:justify-between">
            <div className="max-w-2xl text-center md:text-left">
              <h2 className="mb-3 text-3xl font-bold tracking-tight text-foreground md:text-5xl text-balance">{t.blog.title}</h2>
