...
import type { GetAllQueryParams, GetAllResponse, GetOneParams, GetOneResponse, CreateOneBody, CreateOneResponse, UpdateOneParams, UpdateOneBody, UpdateOneResponse, DeleteOneParams, DeleteOneResponse } from "@/lib/schemas/translations"
	...
	static getAll(query: GetAllQueryParams): GetAllResponse {
		...
		const rows = conditions.length
			? db
					...
					.orderBy(tableTranslations.locale, tableTranslations.section, tableTranslations.key)
					.all()
			: q.all()
