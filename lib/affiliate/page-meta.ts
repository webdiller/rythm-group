...
export const AFFILIATE_DEFAULT_PAGE_DESCRIPTION = "Партнёрство для GameDev и маркетинга: кейсы, вишлисты, форматы сотрудничества. Partnerships for game developers: cases, wishlists, cooperation models."
...
export function getAffiliateSeoFromDb(): { title: string; description: string } {
  ...
  const description = pick(ru, "pageDescription") ?? pick(en, "pageDescription") ?? AFFILIATE_DEFAULT_PAGE_DESCRIPTION
