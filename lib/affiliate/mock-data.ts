...
export const COOPERATION_FORMATS_MOCK: CooperationFormatMock[] = [
  {
    ...
    body_ru: "Продвижение игры через нашу сеть каналов с фокусом на добавления в вишлист: охват целевой аудитории, понятные сроки и отчётность по метрикам.",
    body_en: "Promotion through our channel network focused on wishlist adds: reach for the right audience, clear timelines, and reporting on key metrics.",
    hidden: false,
  },
  {
    id: "ads",
    ...
    body_ru: "Размещение нативных и рекламных интеграций в Telegram: креатив, согласование, публикации и базовая аналитика по охватам и вовлечению.",
    body_en: "Native and ad integrations in Telegram: creative, approvals, publishing, and baseline analytics on reach and engagement.",
    hidden: false,
  },
  {
    id: "revshare",
    ...
    body_ru: "Модель для крупных издателей и студий: совместное продвижение и прозрачное распределение выручки по согласованным правилам.",
    body_en: "For larger publishers and studios: joint promotion and transparent revenue sharing under agreed rules.",
    hidden: false,
  },
  {
    id: "full",
    ...
    body_ru: "Берём на себя весь цикл продвижения под фиксированную стоимость: стратегия, контент, публикации и сопровождение до результата.",
    body_en: "We take the full promotion cycle for a fixed fee: strategy, content, publishing, and support through to results.",
    hidden: false,
  },
]
...
export const AFFILIATE_CASES_MOCK: AffiliateCaseMock[] = [
  {
    ...
    wishlists: "12 400",
    shortDescription_ru: "Аркадный раннер в неоновом киберпанке. Кампания с упором на вишлист и демо на фестивале.",
    shortDescription_en: "Arcade runner in neon cyberpunk. Campaign focused on wishlists and a festival demo.",
    socialScreens: [
      {
    ...
    timeline_ru: "За 14 дней собрали основной объём вишлистов после серии постов и коллабораций с тематическими каналами.",
    timeline_en: "Collected the bulk of wishlists within 14 days after a series of posts and collabs with themed channels.",
  ...
  },
  {
    ...
    wishlists: "8 200",
    shortDescription_ru: "Кооперативный экшен. Подчеркнули социальные доказательства: скриншоты отзывов и ретweets из X.",
    shortDescription_en: "Co-op action. We highlighted social proof: review screenshots and retweets from X.",
    socialScreens: [
      {
...
export const AFFILIATE_FAQ_MOCK: AffiliateFaqMock[] = [
  {
    ...
    answer_ru: "Условия зависят от формата: для стандартных пакетов часто используем предоплату 30–50%, для крупных контрактов — по договорённости.",
    answer_en: "Terms depend on the format: standard packages often use 30–50% prepayment; larger contracts are agreed individually.",
    sort_order: 0,
  },
  {
    id: "faq2",
    ...
    answer_ru: "После согласования креатива и слота — обычно 3–7 рабочих дней. Срочные размещения обсуждаются отдельно.",
    answer_en: "After creative and slot approval — typically 3–7 business days. Rush placements are discussed separately.",
    sort_order: 1,
  },
  {
    id: "faq3",
    ...
    answer_ru: "Безнал для юрлиц по счёту; для международных партнёров — по договору и инвойсу. Детали фиксируем до старта кампании.",
    answer_en: "Wire for legal entities via invoice; for international partners — per contract and invoice. Details are fixed before launch.",
    sort_order: 2,
  },
]
