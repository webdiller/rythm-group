...
export async function getRootShellBackgroundFlags(): Promise<{
  ...
  return {
    ...
    prefetchBackgroundSrcs: [resolveBackgroundSrc("global", "light"), resolveBackgroundSrc("global", "dark"), resolveBackgroundSrc("hero", "light"), resolveBackgroundSrc("hero", "dark")],
  }
}
