...
const coverImageUrl = z.union([z.string().url(), z.string().regex(/^\/[^?\s]+$/, "Invalid url"), z.string().regex(/^blog\/images\/[\w.-]+$/, "Invalid blog cover key"), z.literal(""), z.null()])
...
export const CreatePostBody = z.object({
	...
	cover_image_url: coverImageUrl.optional().transform((v) => (v === "" || v === undefined ? null : v)),
	status: PostStatus,
