 ...
 */
export function getSiteLogoSrc(logo?: string | null, options?: { cacheBust?: string | number }): string {
 ...
 */
export function getSiteFaviconSrc(favicon?: string | null, options?: { cacheBust?: string | number }): string {
