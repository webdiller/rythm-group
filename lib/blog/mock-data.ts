...
export const mockBlogPosts: BlogPost[] = [
  {
    ...
    excerpt_ru:
      "Кратко о релизах, метриках и планах по развитию партнёрских инструментов для издателей и студий.",
    excerpt_en: "A short overview of releases, metrics, and roadmap for partner tooling for publishers and studios.",
    cover_image_url:
      "https://images.unsplash.com/photo-1542751371-adc38448a05e?w=960&q=80&auto=format&fit=crop",
    body_html_ru: `
...
<p><a href="https://t.me" target="_blank" rel="noopener noreferrer">Subscribe to the channel</a></p>
  ...
  },
  {
    ...
    cover_image_url:
      "https://images.unsplash.com/photo-1552820728-8b83bb6b773f?w=960&q=80&auto=format&fit=crop",
    body_html_ru: `
...
<li>Cross-posting helps reach when tone of voice stays consistent</li>
  ...
  },
  {
    ...
    cover_image_url:
      "https://images.unsplash.com/photo-1611162617474-5b21e879e113?w=960&q=80&auto=format&fit=crop",
