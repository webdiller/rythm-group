	...
	ru: {
		...
		affiliate: {
			hero: {
				...
				subtitle: "Кейсы с вишлистами и релизами, прозрачная статистика и команда, которая говорит на языке разработчиков и издателей.",
			...
			casePage: {
				...
				publishedInChannels: "Где публиковалась",
			},
		},
	},
	en: {
		...
		affiliate: {
			hero: {
				...
				subtitle: "Case studies with wishlists and launches, clear stats, and a team that speaks developer and publisher.",
				ctaPrimary: "Apply",
			...
			casePage: {
				...
				publishedInChannels: "Published in",
			},
		},
	},
} as const
