...
export default async function BlogLayout({ children }: Readonly<{ children: React.ReactNode }>) {
	...
	const { siteSettings, hasCustomGlobalBackgroundForBothThemes, headerNavOrder, globalBgLight, globalBgDark } = await getBlogShellMeta()
	...
	return (
		<div className="relative min-h-screen w-full">
			...
			<div className="relative z-20">
				...
				/>
				<main className="mx-auto pt-24 max-w-7xl px-4 pb-20 sm:px-6 lg:px-8">{children}</main>
				<Footer
