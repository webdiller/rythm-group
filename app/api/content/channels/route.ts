...
import { CreateOneBody, UpdateOneBody, DeleteOneParams } from "@/lib/schemas/channels"
...
export async function POST(request: NextRequest) {
	try {
		...
		if (!parsed.success) {
			return NextResponse.json({ error: "name, subscribers, and url are required", errors: parsed.error.flatten() }, { status: 400 })
		}
