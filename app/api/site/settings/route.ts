...
export async function PUT(request: NextRequest) {
	try {
		...
		const currentDisplayMode = (existing?.partnersDisplayMode as PartnersDisplayMode | null | undefined) ?? "logoAndName"
		...
		const currentChannelsCardAlign = (existing?.channels_card_align as ChannelsCardAlign | null | undefined) ?? "left"
		const currentLogoText = existing?.logo_text ?? null
		const currentContactLayout = (existing?.contactLayout as ContactLayout | null | undefined) ?? "formFirst"
		const currentContactFormHidden = existing?.contactFormHidden ?? false
		const currentAffiliateContactLayout = (existing?.affiliate_contact_layout as ContactLayout | null | undefined) ?? "formFirst"
		...
		const updateValues = {
			logo_text: body.logo_text === undefined ? currentLogoText : body.logo_text ? body.logo_text.trim() : null,
			privacyPolicyUrl: body.privacyPolicyUrl ?? null,
			dataProcessingPolicyUrl: body.dataProcessingPolicyUrl ?? null,
			heroAnimationEnabled: typeof body.heroAnimationEnabled === "boolean" ? body.heroAnimationEnabled : true,
			partnersDisplayMode: body.partnersDisplayMode ?? currentDisplayMode,
			channels_show_subscribers: typeof body.channels_show_subscribers === "boolean" ? body.channels_show_subscribers : currentChannelsShowSubscribers,
			channels_show_reach: typeof body.channels_show_reach === "boolean" ? body.channels_show_reach : currentChannelsShowReach,
			channels_card_align: body.channels_card_align === "left" || body.channels_card_align === "center" || body.channels_card_align === "right" ? body.channels_card_align : currentChannelsCardAlign,
			contactLayout: body.contactLayout ?? currentContactLayout,
			contactFormHidden: typeof body.contactFormHidden === "boolean" ? body.contactFormHidden : currentContactFormHidden,
			affiliate_contact_layout: body.affiliate_contact_layout ?? currentAffiliateContactLayout,
			affiliate_contact_form_hidden: typeof body.affiliate_contact_form_hidden === "boolean" ? body.affiliate_contact_form_hidden : currentAffiliateContactFormHidden,
			blog_show_dates: typeof body.blog_show_dates === "boolean" ? body.blog_show_dates : currentBlogShowDates,
			affiliate_show_blog_block: typeof body.affiliate_show_blog_block === "boolean" ? body.affiliate_show_blog_block : currentAffiliateBlog,
			affiliate_show_hero: typeof body.affiliate_show_hero === "boolean" ? body.affiliate_show_hero : currentAffiliateHero,
			affiliate_show_formats: typeof body.affiliate_show_formats === "boolean" ? body.affiliate_show_formats : currentAffiliateFormats,
			affiliate_show_cases: typeof body.affiliate_show_cases === "boolean" ? body.affiliate_show_cases : currentAffiliateCases,
			affiliate_show_steam: typeof body.affiliate_show_steam === "boolean" ? body.affiliate_show_steam : currentAffiliateSteam,
			affiliate_show_faq: typeof body.affiliate_show_faq === "boolean" ? body.affiliate_show_faq : currentAffiliateFaq,
			affiliate_show_contacts: typeof body.affiliate_show_contacts === "boolean" ? body.affiliate_show_contacts : currentAffiliateContacts,
			page_blog_enabled: typeof body.page_blog_enabled === "boolean" ? body.page_blog_enabled : currentPageBlogEnabled,
			page_affiliate_enabled: typeof body.page_affiliate_enabled === "boolean" ? body.page_affiliate_enabled : currentPageAffiliateEnabled,
			site_published: typeof body.site_published === "boolean" ? body.site_published : currentSitePublished,
			headerNavOrder: JSON.stringify(Array.isArray(body.headerNavOrder) ? normalizeHeaderNavOrder(body.headerNavOrder) : currentHeaderNavOrder),
		}

		if (existing) {
			const [updated] = db.update(tableSiteSettings).set(updateValues).where(eq(tableSiteSettings.id, existing.id)).returning().all()
